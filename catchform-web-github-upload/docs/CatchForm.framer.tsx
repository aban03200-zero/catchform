                    ...
                    <div>
                        ...
                        <div style={{ position: "relative", height: WHEEL_ITEM_HEIGHT * WHEEL_VISIBLE_ITEMS, borderRadius: 18, border: `1px solid ${FC.fieldBorder}`, background: FC.fieldBg, boxShadow: "inset 0 0 0 1px rgba(255,255,255,0.02)", overflow: "hidden" }}>
                            ...
                            <div className="cf-date-wheel-list" ref={node => { if (node && node.dataset.syncKey !== syncKey && node.dataset.userScrolling !== "1") { node.dataset.syncKey = syncKey; node.scrollTop = activeIndex * WHEEL_ITEM_HEIGHT } }}
                                ...
                                style={{ position: "relative", zIndex: 2, height: "100%", padding: "0 7px", boxSizing: "border-box", overflowY: "auto", overscrollBehavior: "contain", touchAction: "pan-y", scrollSnapType: "y mandatory", WebkitOverflowScrolling: "touch", scrollbarWidth: "none" }}>
    ...
    return (
        <div style={{ width: "100%", minHeight: "100vh", background: FC.bg, color: FC.t1, "--link-color": accentBg } as React.CSSProperties}>
            ...
            <div style={{ display: "flex", gap: 10, marginTop: 8 }}>
                {isMultiPage && page > 1 && <button onClick={goPreviousPage} style={{ flex: 1, height: cfg.cta.height, borderRadius: fr, border: "none", background: FC.fieldBg || "#F2F4F6", color: FC.t2, fontFamily: FONT, fontSize: 14, fontWeight: 600, cursor: "pointer" }}>이전</button>}
            ...
            {showModal && <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 1000 }}>
                <div style={{ background: FC.bg || "#fff", borderRadius: 16, padding: "32px 28px", width: "min(560px,calc(100% - 32px))", boxShadow: "0 8px 32px rgba(0,0,0,0.3)", textAlign: "center" }}>
                    ...
                    <div style={{ fontSize: 18, fontWeight:600, color: FC.t1, marginBottom: modalTitleMarginBottom, letterSpacing: "-0.3px" }}>{cfg.modal.title}</div>
                    {cfg.modal.body && <div style={{ fontSize: 13.5, color: FC.t2, lineHeight: 1.6, marginBottom: modalBodyMarginBottom }}>{cfg.modal.body}</div>}
